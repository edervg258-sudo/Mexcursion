-- ============================================================
--  MEXCURSIÓN — Initial Schema Migration
--  Migration: 20260424_120000
--  Description: Create core tables, functions, triggers, and RLS policies
-- ============================================================

-- Migration tracking table (added for governance)
